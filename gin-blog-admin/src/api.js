...
export default {
  ...
  //日记相关接口
  getDiaryList:(params = {}) =>request.get('/diary/list', { params }),
  getDiaryById: id => request.get(`/diary/${id}`),
  saveOrUpdateDiary: data => request.post('/diary', data),
  deleteDiary: (data = []) => request.delete('/diary', { data }), // 物理删除
  softDeleteDiary: (ids, is_delete) => request.put('/diary/soft-delete', { ids, is_delete }), // 软删除
